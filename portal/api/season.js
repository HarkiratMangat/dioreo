...
//
// Season realm — covers /manage's 'draws', 'calendar', 'patchnotes', 'seasondraft' and 'season'
// pages (spec \u00a78.2's join table). Read-only here: mutations go through the generic
// portal/api/changesets.js pathway as ops built by the frontend (draw.add, calendar.edit, etc.).
