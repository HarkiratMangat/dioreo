...
// ==========================================
// /timestamp's style dropdown. Lifted out of handlers/router.js on 2026-08-13 17:45 EDT (docs/ROADMAP.md's index.js
// split). The branch bodies are VERBATIM -- only their address changed.
//
// Ownership is decided by custom_id prefix, once, before any branch runs: `tsmenu|`.
...
//
// ⚠️ THE CRASH NET IS THE ROUTER'S, NOT THIS FILE'S. handleTimestampInteraction is awaited from
