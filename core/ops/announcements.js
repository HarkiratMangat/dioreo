    ...
    'announcement.post': {
        ...
        apply: async (op, { session, actorId }) => {
            ...
            return {
                ...
                applied: { id: res.id, color, createdAt: doc.createdAt || new Date(), createdBy: doc.createdBy }
            };
        },
    ...
    'announcement.edit': {
        ...
        apply: async (op, { session }) => {
            ...
            return {
                ...
                applied: { id: op.target.id, prior: { text: cur.text, expiresAt: cur.expiresAt, startsAt: cur.startsAt || null } }
            };
        },
