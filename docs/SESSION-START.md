...
> 🔴 **FIRST ACTION, 2026-09-06 18:11 EDT — READ THE PLAN, THEN THE HANDOFF.** `docs/superpowers/plans/2026-09-06-portal-step3-step4-completion.md` is TRACKED and is the plan for finishing the portal. `local/handoff/2026-09-06-portal-step3-exhaustive-handoff.md` is the narrative half and is gitignored. **The unit of work is the FILED ITEM, never the realm** — three plans were retired on 2026-09-06 and a per-realm loop is the first of them. **Before any pop-up asking Harkirat to decide, `ctx_search` `docs/reference/portal-decision-ledger.md`**: four settled items were surfaced to him as live work in one day. The previous FIRST ACTION below is kept as history.
