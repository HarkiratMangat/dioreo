...
| Data | What it is | Why we have it |
|---|---|---|
| **Portal session** | A hashed session id, your Discord user ID, when you signed in, when you were last active, and a short device/browser string (e.g. "Mozilla/5.0 ...") | Keeps you signed in for up to 12 hours, and lets the owner see and end active sessions from the Access page |
