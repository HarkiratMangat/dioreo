...
(scope ONLY — ⚠️ the model is a SEPARATE axis, picked from the premise-risk × deliberation-load grid,
not implied by the tier); flags 🔗bundle-with 🧩needs-design ⛓️blocked-by. The near-term **v2**
