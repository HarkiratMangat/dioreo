...
| 6 | ✅ **CLOSED 2026-09-09 14:32 EDT except one fork.** (2) verified done in the harness · (4) not to be chased, by its own filing · (5) and (7) decided with Harkirat 2026-09-08 · (11) deleted, the role does not exist · (12) a reasoned keep already recorded in `tokens.css` itself. **Open: (10) only** — marking the Manifest row whose preview drawer is open, which neither side draws, so it is design to invent rather than port | (10) is his | 7 |
