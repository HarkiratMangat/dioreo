...
| `MEMORY.md` is **30,504 B / 151 lines** — deliberately OVER the limit, and bridged by the HOOK FALLBACK, not by the import (measured 2026-09-02 22:27 EDT: zero `include` rows in four session starts) | MEASURED (the 22,230/151 figure was the rejected trim) |
