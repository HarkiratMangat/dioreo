...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        // Reordered 2026-08-13 (Harkirat: "page/source/visibility reads better than leading with
        // visibility") -- Discord's option picker follows registration order, not alphabetical, so
        // this order IS the display order.
        // Jump straight to a specific source page instead of always landing on Avatar.
        // Values match utils/colorPaletteView.js's SOURCE_META keys exactly.
        ...
        // Renamed 'from' -> 'source' with clearer choice labels 2026-08-13 (Harkirat's request).
    ...
    async execute(interaction) {
        ...
        // (or a server where you don't) shows your global ones. `source:main` forces global;
        // `source:server` forces server and errors below if there is nothing to show.
        ...
        // Only the landing page is extracted here -- other sources lazily extract when the
