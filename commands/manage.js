...
function buildAddLoadoutModal(mode) {
    ...
    modal.addComponents(
        ...
        new ActionRowBuilder().addComponents(new TextInputBuilder().setCustomId('build').setLabel('Build Name | Share Code (optional)').setStyle(TextInputStyle.Short).setPlaceholder('Aggressive Flex | ABCD-1234-EFGH').setRequired(true)),
...
function buildEditLoadoutModal(targetLoadout, targetId) {
    ...
    modal.addComponents(
        ...
        new ActionRowBuilder().addComponents(new TextInputBuilder().setCustomId('build').setLabel('Build Name | Share Code (optional)').setStyle(TextInputStyle.Short).setValue(targetLoadout.buildName + (targetLoadout.shareCode ? ` | ${targetLoadout.shareCode}` : ''))),
